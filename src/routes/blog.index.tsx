...
function Blog() {
  ...
  useEffect(() => {
    ...
    const channel = supabase.channel('public:blogs')
              ...
              {posts.map((b) => (
                <Card key={b.id} className="overflow-hidden border-border group hover:shadow-elegant transition-all">
                  ...
                  <div className="p-6">
                    ...
                    <Link to="/blog/$slug" params={{ slug: b.slug }} className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-primary hover:gap-2 transition-all">
