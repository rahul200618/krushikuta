        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-64 lg:h-screen lg:sticky lg:top-0 shrink-0 flex flex-col bg-white border-r border-[#e0e8e2] p-6 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            ...
            <TabsList className="flex lg:flex-col justify-start bg-transparent p-0 w-full h-auto overflow-x-auto lg:overflow-visible gap-2 flex-1">
              ...
              <TabsTrigger value="mock-tests" className="w-full justify-start text-left rounded-lg py-2.5 px-3 text-sm font-medium whitespace-nowrap text-[#5e7a63] hover:bg-[#f4f7f4] data-[state=active]:bg-[#eaf2eb] data-[state=active]:text-[#2c5f34] data-[state=active]:shadow-none transition-colors">Exams</TabsTrigger>
            </TabsList>
